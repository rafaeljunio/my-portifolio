      ...
      <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
        <div>
          ...
          <p className="mt-[1.5rem] text-[20px] text-[#ffffff92]">
            ...
            quaerat modi laboriosam vitae officia illo debitis repellendus sit
            labore corrupti atque beatae, dolore minima eligendi. Accusamus
            quibusdam sequi ullam sit?
          </p>
